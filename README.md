...
variables drop out of the equations. For example, an inviscid flow would have the entire fraction term go to zero in equation 2 due to the lack of shear forces in an idealized reversible fluid flow.
